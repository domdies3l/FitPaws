...
public class BluetoothActivity extends AppCompatActivity {
    public final AppCompatActivity activity = BluetoothActivity.this;
    ...
    private static final String bluetoothAddress = "3C:A3:08:C1:EC:BD";
    ...
    private ScanCallback scanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if(address.equals(bluetoothAddress)){
                Intent i = new Intent();
                i.setClass(getBaseContext(), ControlActivity.class);
                i.putExtra(ControlActivity.EXTRAS_DEVICE_NAME,
                        result.getDevice().getName());
                i.putExtra(ControlActivity.EXTRAS_DEVICE_ADDRESS,
