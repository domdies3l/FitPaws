...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    private static final String COLUMN_USER_BREED = "user_breed";
    private static final String COLUMN_USER_SEX = "user_sex";
    private static final String COLUMN_USER_COLOR = "user_color";
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_USER_AGE, (Integer) null);
        values.put(COLUMN_USER_WEIGHT, (Double) null);
        values.put(COLUMN_USER_SEX, (String) null);
        values.put(COLUMN_USER_COLOR, (String) null);
        values.put(COLUMN_USER_BREED, (String) null);
    ...
    public String getUsername(String email, String password) {
        ...
        String user = null;
        if(cursor.moveToFirst())
            user = cursor.getString(cursor.getColumnIndex(COLUMN_USER_NAME));
